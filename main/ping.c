...
/**
 * Callback when ping times out waiting for response
 * @param hdl Ping session handle
 * @param args Callback arguments
 */
...
/**
 * Callback when ping session ends
 * @param hdl Ping session handle
 * @param args Callback arguments
 */
...
/**
 * Register ping command with console
 */
...
/**
 * Add ping command to debug console
 */

...
#define SENDER_MAIL         "sender@example.com"
#define SENDER_PASSWORD     "FAKEPASSWORD123"
#define RECIPIENT_MAIL      "recipient@example.com"

#define SERVER_USES_STARTSSL 0
...
static void smtp_client_task(void *pvParameters)
{
    ...
    /* Get response */
    ESP_LOGI(TAG, "Getting response from server...");
...
exit:
    ...
    vTaskDelete(NULL);
    ESP_LOGI(TAG, "SMTP client task exited!");
}
